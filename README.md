...
- **Frontend**: React 19.0.0, React Router DOM, Redux Toolkit, React Bootstrap, Axios, React Multi Carousel
- **Backend**: Node.js, Express.js, MySQL2, Bcrypt, CORS
- **API**: TMDB API, Google Translate API
...
### 4. 데이터베이스 설정
MySQL 데이터베이스를 생성하고 다음 테이블을 생성하세요:
